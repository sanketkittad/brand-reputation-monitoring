...
dir1 = "D:\BE-Project-23-24\model\Samsung"  # Replace with the actual path to directory A
dir2 = "D:\BE-Project-23-24\model\Oppo"  # Replace with the actual path to directory B
...
for i in range(len(dir1_list)):
    ...
    new_file2_path = os.path.join(dir2, "o"+dir1_list[i][1:])  # Construct new path with filename from dir1
